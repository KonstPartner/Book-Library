    ...
    <div className="min-h-screen bg-gradient-to-tl from-indigo-300 via-gray-200 to-teal-300 dark:from-indigo-900 dark:via-gray-800 dark:to-teal-900 p-6 overflow-hidden relative">
      <div className="flex flex-col max-w-5xl md:w-[90%] mx-auto relative">
        <div className="flex justify-end">
          <div className="w-full bg-gradient-to-br from-white/20 to-gray-100/20 dark:from-gray-800/20 dark:to-gray-900/20 backdrop-blur-2xl rounded-2xl shadow-xl border border-white/40 dark:border-gray-700/40 p-8 md:py-20 text-center animate-slide-in-from-right">
