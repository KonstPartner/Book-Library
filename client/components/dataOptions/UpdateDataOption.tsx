  ...
  return (
    <div className="my-2 flex justify-end">
      <Button
        ...
        className="bg-gray-50 dark:text-white dark:bg-transparent border-2 hover:bg-yellow-300 dark:hover:bg-yellow-300 hover:text-white hover:border-transparent py-1"
      >
        Edit
      </Button>
